...
func (w *workerDelegate) selectMachineImageForWorkerPool(name, version string, machineCapabilities gardencorev1beta1.Capabilities) (*v1alpha1.MachineImage, error) {
	selectedMachineImage := &v1alpha1.MachineImage{
		Name:    name,
		Version: version,
	}
...
func appendMachineImage(machineImages []v1alpha1.MachineImage, machineImage v1alpha1.MachineImage, capabilityDefinitions []gardencorev1beta1.CapabilityDefinition) []v1alpha1.MachineImage {
	...
	if len(capabilityDefinitions) == 0 {
		...
		return append(machineImages, v1alpha1.MachineImage{
	...
	machineImages = append(machineImages, v1alpha1.MachineImage{
		Name:         machineImage.Name,
		Version:      machineImage.Version,
		Image:        machineImage.Image,
