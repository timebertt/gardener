...
const ControllerName = "backupdownload_controller"
...
func AddToManagerWithOptions(mgr manager.Manager, opts backupoptions.AddOptions) error {
	return backupdownload.Add(mgr, backupdownload.AddArgs{
		Actuator:          newActuator(opts.ContainerMountPath, opts.BackupBucketPath),
		ControllerOptions: opts.Controller,
		Predicates:        backupdownload.DefaultPredicates(opts.IgnoreOperationAnnotation),
		Type:              local.Type,
	})
}
