...
type secret interface {
	*corev1.Secret | *gardencorev1beta1.InternalSecret

	client.Object
}

// Reader is part of the SecretsManager interface and allows retrieving secrets from a SecretsManager.
type Reader = GenericReader[*corev1.Secret]

// GenericReader is part of the SecretsManager interface and allows retrieving secrets from a SecretsManager.
type GenericReader[T secret] interface {
	...
	Get(string, ...GetOption) (T, bool)
}

// Interface describes the methods for managing secrets.
type Interface = Generic[*corev1.Secret]

// Generic describes the methods for managing secrets.
type Generic[T secret] interface {
	...
	Generate(context.Context, secretsutils.ConfigInterface, ...GenericGenerateOption[T]) (T, error)
