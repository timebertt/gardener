...
func NewREST(optsGetter generic.RESTOptionsGetter) *REST {
	store := &genericregistry.Store{
		NewFunc:                  func() runtime.Object { return &gardencore.InternalSecret{} },
		NewListFunc:              func() runtime.Object { return &gardencore.InternalSecretList{} },
		PredicateFunc:            internalsecret.Matcher,
		DefaultQualifiedResource: gardencore.Resource("internalsecrets"),
	...
	options := &generic.StoreOptions{
		...
		TriggerFunc: map[string]storage.IndexerFunc{"metadata.name": internalsecret.NameTriggerFunc},
	}
